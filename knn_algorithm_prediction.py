...
def bat(team):
    ...
    KNN = KNeighborsClassifier(n_neighbors = 42) # dist(x, y) = sqrt(sum((xi - yi)**2))
...
def bowl(team):
    ...
    KNN = KNeighborsClassifier(n_neighbors = 22) # dist(x, y) = sqrt(sum((xi - yi)**2))
...
def all_round(team):
    ...
    KNN = KNeighborsClassifier(n_neighbors = 31) # dist(x, y) = sqrt(sum((xi - yi)**2))
