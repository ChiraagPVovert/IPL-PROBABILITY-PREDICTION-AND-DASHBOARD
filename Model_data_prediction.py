...
import decision_tree_algorithm_prediction
...
def model_predictions(team,model_algorithm):
    ...
    if model_algorithm == 'KNN':
        ...
        final_bat_and_wk_proba = ann_lr_bat.model_predictions(team)
        final_bowler_proba = ann_lr_bowl.model_predictions(team)
        final_all_rounder_proba = ann_lr_all_round.model_predictions(team)
        ...
        final_all_rounder_proba = logistic_regression_algorithm_prediction.bat(team)
        final_bat_and_wk_proba = logistic_regression_algorithm_prediction.bowl(team)
        final_bowler_proba = logistic_regression_algorithm_prediction.all_round(team)
