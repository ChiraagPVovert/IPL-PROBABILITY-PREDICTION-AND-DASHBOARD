...
dash.register_page(__name__, name = '2008 IPL', order=1111000000000000000,
                   meta_tags=[{'name': 'viewport',
                               'content': 'width=device-width, initial-scale=1.0, maximum-scale=1.2, minimum-scale=0.5,'
                               }]
                   )

df = pd.read_excel('assets/IPL/2008_ipl/points_table_ipl_2008.xlsx')
df = df.fillna(' ')
...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('POINTS TABLE - 2008 IPL', style={'textAlign': 'center'}),
                    html.Br(),
                    html.Div(df_fig),
                    html.Br(),
                    #html.Div(fig),
