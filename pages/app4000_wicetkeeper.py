...
def output(n_clicks, need, o1, o2):
    ...
    wk = pd.read_excel('assets/Player_Stats/WK_dismissal_complete.xlsx')
    wk_innings = pd.read_excel('assets/Player_Stats/WK_dismissal_innings.xlsx')
    ...
    if need == 'MOST DISMISSALS INVOLVING A WICKET KEEPER':
        ...
        wk = wk
        df1_fig = ff.create_table(wk.head(50), index=False)
