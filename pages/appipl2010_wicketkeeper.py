...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('WICKET KEEPER - 2010 IPL', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST DISMISSALS INVOLVING A WICKET KEEPER',
                                            'MOST DISMISSALS INVOLVING A WICKET KEEPER IN AN INNINGS'], id='request_wk_ipl_2010')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_wk_ipl_2010'),
                    html.Br(),
                    html.Div([], id='service_2_wk_ipl_2010')
...
@dash.callback(
        ...
        [
            Output('service_1_wk_ipl_2010', 'children'),
            Output('service_2_wk_ipl_2010', 'children'),
        ],
        ...
        [
            State("request_wk_ipl_2010", 'value'),
            State('service_1_wk_ipl_2010', 'children'),
            State('service_2_wk_ipl_2010', 'children'),
        ],
...
def output(n_clicks, need, o1, o2):
    ...
    wk = pd.read_excel('assets/IPL/2010_ipl/most_dismissals_by_wk_ipl_2010.xlsx')
    wk_innings = pd.read_excel('assets/IPL/2010_ipl/most_dismissals_in_an_innings_by_wk_ipl_2010.xlsx')
