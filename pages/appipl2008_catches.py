...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('CATCHES - 2008 IPL', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST CATCHES (EXCLUDING WICKET KEEPER)',
                                            'MOST CATCHES IN A MATCH (EXCLUDING WICKET KEEPER)'], id='request_catch_ipl_2008')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_catch_ipl_2008'),
                    html.Br(),
                    html.Div([], id='service_2_catch_ipl_2008')
...
@dash.callback(
    ...
    [
        Output('service_1_catch_ipl_2008','children'),
        Output('service_2_catch_ipl_2008','children'),
    ],
    ...
    [
        State("request_catch_ipl_2008", 'value'),
        State('service_1_catch_ipl_2008','children'),
        State('service_2_catch_ipl_2008','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    catches = pd.read_excel('assets/IPL/2008_ipl/most_catches_ipl_2008.xlsx')
    catches_in_an_innings = pd.read_excel('assets/IPL/2008_ipl/most_catches_in_an_innings_ipl_2008.xlsx')
