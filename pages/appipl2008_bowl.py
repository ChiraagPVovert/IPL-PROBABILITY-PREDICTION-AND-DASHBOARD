    ...
    return html.Div([
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        html.H3('BOWLING - 2008 IPL', style={'textAlign': 'center'}),
                        html.Br(),
                        html.Div([dcc.Dropdown(['MOST WICKETS', 'MOST OVERS BOWLED', 'MOST MAIDEN OVERS BOWLED',
                                                ...
                                                'BEST ECONOMY IN AN INNINGS'], id='request_bowl_ipl_2008')]),
                        html.Br(),
                        html.Div(
                            [
                        ...
                        html.Br(),
                        html.Div([], id='service_1_ipl_2008_bowl'),
                        html.Br(),
                        html.Div([], id='service_2_ipl_2008_bowl')
...
@dash.callback(
    ...
    [
        Output('service_1_ipl_2008_bowl', 'children'),
        Output('service_2_ipl_2008_bowl', 'children'),
    ],
    ...
    [
        State("request_bowl_ipl_2008", 'value'),
        State('service_1_ipl_2008_bowl', 'children'),
        State('service_2_ipl_2008_bowl', 'children'),
    ],
...
def output(n_clicks, need, o1, o2):
    bowling = pd.read_excel('assets/IPL/2008_ipl/bowl_wkts_avg_econ_sr_4w_5w_bbi_ipl_2008.xlsx')
    bowling_in_an_innings = pd.read_excel('assets/IPL/2008_ipl/bowl_innings_wkts_econ_runsconc_sr_ipl_2008.xlsx')
    ...
    if need == 'MOST WICKETS':
        ...
        bowling = pd.read_excel('assets/IPL/2008_ipl/bowl_innings_most_runs_conceded_ipl_2008.xlsx')
        ...
        bowling_data = bowling[
            ['PLAYER', 'OVERS', 'MAIDENS', 'RUNS', 'WICKETS', 'ECONOMY', 'STRIKE RATE', 'TEAM', 'OPPOSITION']]
        bowling_10 = bowling.head(8)
        df1_fig = dbc.Table.from_dataframe(bowling_data.head(8), striped=True, bordered=True, hover=True)
