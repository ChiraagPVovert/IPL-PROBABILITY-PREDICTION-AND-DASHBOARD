...
dash.register_page(__name__, name='DATA ANALYSIS',order = 11110000000000000)

app = dash.Dash(__name__)

teams = ['Chennai Super Kings','Delhi Capitals','Gujurat Titans','Kings XI Punjab','Kolkata Knight Riders',
         'Lucknow Super Giants','Mumbai Indians','Rajasthan Royals','Royal Challengers Bengaluru','Sunrisers Hyderabad']
model_algorithms = ['K-Nearest Neighbors','Support Vector Machine','Logistic Regression','Artificial Neural Network']
            ...
            dbc.Row(
                [
                    ...
                    html.Div(
                        ...
                        dbc.Col(
                            [
                                dcc.Dropdown(options=model_algorithms,id='algo')
                            ], xs=10, sm=10, md=8, lg=4, xl=4, xxl=4
                        ),
                        ],style={"display": "flex", "justifyContent": "center"},
                    ),
...
def update_output(n_clicks,teams_val,algo_val,bat_plot,bowl_plot,all_round_plot):
    ...
    if algo_val == 'K-Nearest Neighbors':
        ...
        algo = 'LR'
    elif algo_val == 'Artificial Neural Network':
        algo = 'ANN'
    ...
    fig_bowl.update_layout(title_text="BOWLER",annotations=[dict(text='BOWLERS', x=0.5, y=0.5, font_size=10, showarrow=False)])
