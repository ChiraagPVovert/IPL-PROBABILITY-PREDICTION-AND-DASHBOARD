...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('BATTING - 2010 IPL', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST RUNS', 'HIGHEST SCORERS IN AN INNINGS', 'BEST AVERAGE',
                                            ...
                                            'MOST RUNS FROM BOUNDARIES IN AN INNINGS'], id='request_bat_ipl_2010')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([],id='service_1_ipl_2010_bat'),
                    html.Br(),
                    html.Div([], id='service_2_ipl_2010_bat')
...
@dash.callback(
    ...
    [
        Output('service_1_ipl_2010_bat','children'),
        Output('service_2_ipl_2010_bat','children'),
    ],
    ...
    [
        State("request_bat_ipl_2010", 'value'),
        State('service_1_ipl_2010_bat','children'),
        State('service_2_ipl_2010_bat','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    batting = pd.read_excel('assets/IPL/2010_ipl/bat_most_runs_hs_avg_sr_bf_no_hund_fifties_ducks_sixes_fours_ipl_2010.xlsx')
    batting_in_an_innings = pd.read_excel('assets/IPL/2010_ipl/bat_most_runs_from_fours_and_sixes_in_an_innings_ipl_2010.xlsx')
    ...
    if need == 'MOST RUNS':
        ...
        batting_10 = batting.head(4)
        df1_fig = dbc.Table.from_dataframe(batting_data.head(4), striped=True, bordered=True, hover=True)
        ...
        batting_10 = batting.head(10)
        df1_fig = dbc.Table.from_dataframe(batting_data.head(47), striped=True, bordered=True, hover=True)
