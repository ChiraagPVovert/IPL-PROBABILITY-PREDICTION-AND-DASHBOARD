...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('PARTNERSHIPS - 2009 IPL', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['PARTNERSHIP BY RUNS','PARTNERSHIP BY WICKETS'], id='request_partner_ipl_2009')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_partner_ipl_2009'),
                    html.Br(),
                    html.Div([], id='service_2_partner_ipl_2009')
...
@dash.callback(
    ...
    [
        Output('service_1_partner_ipl_2009','children'),
        Output('service_2_partner_ipl_2009','children'),
    ],
    ...
    [
        State("request_partner_ipl_2009", 'value'),
        State('service_1_partner_ipl_2009','children'),
        State('service_2_partner_ipl_2009','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    partnership_by_runs = pd.read_excel('assets/IPL/2009_ipl/highest_partnership_by_runs_ipl_2009.xlsx')
    partnership_by_wicket = pd.read_excel('assets/IPL/2009_ipl/highest_partnership_by_wickets_ipl_2009.xlsx')
