...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('LARGEST VICTORIES - 2008 IPL', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['LARGEST VICTORY BY RUNS', 'LARGEST VICTORY BY WICKETS'], id='request_victory_ipl_2008')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_victory_ipl_2008'),
                    html.Br(),
                    html.Div([], id='service_2_victory_ipl_2008')
...
@dash.callback(
    ...
    [
        Output('service_1_victory_ipl_2008','children'),
        Output('service_2_victory_ipl_2008','children'),
    ],
    ...
    [
        State("request_victory_ipl_2008", 'value'),
        State('service_1_victory_ipl_2008','children'),
        State('service_2_victory_ipl_2008','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    victory_by_wickets = pd.read_excel('assets/IPL/2008_ipl/largest_victories_by_wickets_ipl_2008.xlsx')
    victory_by_runs = pd.read_excel('assets/IPL/2008_ipl/largest_victories_by_runs_ipl_2008.xlsx')
