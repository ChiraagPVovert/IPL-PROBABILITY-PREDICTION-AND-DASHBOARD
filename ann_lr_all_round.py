...
def initialize_data():
    ...
    all_rounder_df = all_rounder_df[['INNINGS_PLAYED_BATTING','RUNS','BATTING_AVG','BATTING_STRIKE_RATE','INNINGS_BOWLED','WICKETS','BOWLING_AVERAGE','ECONOMY','BOWLING_STRIKE_RATE','IN_LATEST_SQUAD']]
    # all_rounder_df.shape

    all_rounder_df[['INNINGS_PLAYED_BATTING','RUNS','BATTING_AVG','BATTING_STRIKE_RATE','INNINGS_BOWLED','WICKETS','BOWLING_AVERAGE','ECONOMY','BOWLING_STRIKE_RATE','IN_LATEST_SQUAD']] = all_rounder_df[['INNINGS_PLAYED_BATTING','RUNS','BATTING_AVG','BATTING_STRIKE_RATE','INNINGS_BOWLED','WICKETS','BOWLING_AVERAGE','ECONOMY','BOWLING_STRIKE_RATE','IN_LATEST_SQUAD']].astype(float)
    # all_rounder_df.info()

    # print(all_rounder_df.isnull().sum())

    data = all_rounder_df[['INNINGS_PLAYED_BATTING','RUNS','BATTING_AVG','BATTING_STRIKE_RATE','INNINGS_BOWLED','WICKETS','BOWLING_AVERAGE','ECONOMY','BOWLING_STRIKE_RATE','IN_LATEST_SQUAD']]
    ...
    x_train = df_train[['INNINGS_PLAYED_BATTING','RUNS','BATTING_AVG','BATTING_STRIKE_RATE','INNINGS_BOWLED','WICKETS','BOWLING_AVERAGE','ECONOMY','BOWLING_STRIKE_RATE']]
    x_test = df_test[['INNINGS_PLAYED_BATTING','RUNS','BATTING_AVG','BATTING_STRIKE_RATE','INNINGS_BOWLED','WICKETS','BOWLING_AVERAGE','ECONOMY','BOWLING_STRIKE_RATE']]
    y_train = df_train[['IN_LATEST_SQUAD']]
    y_test = df_test[['IN_LATEST_SQUAD']]
...
def model_predictions(team):
    ...
    all_round_options = ['All Rounder']
    in_latest_squad =['YES','NO']

    all_rounder_df = df[df['TEAM'] == team]
    all_rounder_df = all_rounder_df[all_rounder_df['IN_LATEST_SQUAD'].isin(in_latest_squad)]
    all_rounder_df = all_rounder_df[all_rounder_df['ROLE'].isin(all_round_options)]
    all_rounder_df = all_rounder_df[['PLAYERS','NO_OF_MATCHES_PLAYED','INNINGS_PLAYED_BATTING','RUNS','BATTING_AVG','BATTING_STRIKE_RATE','INNINGS_BOWLED','WICKETS','BOWLING_AVERAGE','ECONOMY','BOWLING_STRIKE_RATE','IN_LATEST_SQUAD']]
    all_rounder_df = all_rounder_df.reset_index(drop=True)
    #all_rounder_df = all_rounder_df[['INNINGS_PLAYED_BATTING','RUNS','BATTING_AVG','BATTING_STRIKE_RATE','INNINGS_BOWLED','WICKETS','BOWLING_AVERAGE','ECONOMY','BOWLING_STRIKE_RATE','IN_LATEST_SQUAD']].copy()
    ...
    X_all_round = X_all_round.transpose()

    # print(X_bowl)

    prediction, prob = predict(params, X_all_round)
...
#prob = model_predictions('Rajasthan Royals')
